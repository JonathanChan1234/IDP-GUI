...
def countdown1():
    ...
    if remaining1 > 0:
         ...
         counting1 = 0
         selectExtraTime1 = 0
         data = {'date': currentParkTime1, 'duration': remaining1, "paid": counting1, "verification": 0}
...
def countdown2():
    ...
    if remaining2 > 0:
         ...
         data = {'date': currentParkTime2, 'duration': remaining2, "paid": counting2, "code": 0}
         ...
         counting2 = 0
         selectExtraTime2 = 0
         data = {'date': currentParkTime2, 'duration': remaining2, "paid": counting2, "verification": 0}
    ...
    if spotSelected == 0:
        if counting1 == 0:
            ...
            if tryremaining1 <= 120:
                ...
                remaining1 = 120
        code = verificaton()
        data = {'date': currentParkTime1, 'duration': remaining1, "paid": counting1, "verification": code}
        result = firebase.put('', '0019', data)
    else:
            if counting2 == 0:
                ...
                if tryremaining2 <= 120:
                    ...
                    remaining2 = 120
            code = verificaton()
            data = {'date': currentParkTime2, 'duration': remaining2, "paid": counting2, "verification": code}
            result = firebase.put('', '0020', data)
    selectTime1 = 0
    selectTime2 = 0
    selectExtraTime1 = 0
